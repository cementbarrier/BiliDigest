...
| # | 问题 | 根因 | 修复 |
|---|------|------|------|
| 43 | 关闭对话框确认按钮无视觉区分 | 取消/确认按钮外观相同 | 确认按钮蓝底白字 `bg="#0078D4" fg="white"` |
| 44 | WM_DELETE_WINDOW 协议可能不生效 | 协议注册在 `if HAS_TRAY:` 内 | 提到条件外，无论托盘是否可用都弹出关闭对话框 |
